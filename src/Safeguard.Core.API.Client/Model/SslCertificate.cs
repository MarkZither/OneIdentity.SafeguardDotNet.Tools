...
namespace IO.Swagger.Model {
  ...
  public class SslCertificate {
    ...
    /// <summary>
    /// Base64 encoded certificate DER data (write-only)
    /// </summary>
    /// <value>Base64 encoded certificate DER data (write-only)</value>
    ...
    /// <summary>
    /// The passphrase for decrypting the certificate (write-only) (Read-only)
    /// </summary>
    /// <value>The passphrase for decrypting the certificate (write-only) (Read-only)</value>
    ...
    /// <summary>
    /// Cluster members this SSL certificate is assigned to
    /// </summary>
    /// <value>Cluster members this SSL certificate is assigned to</value>
    [DataMember(Name="Appliances", EmitDefaultValue=false)]
