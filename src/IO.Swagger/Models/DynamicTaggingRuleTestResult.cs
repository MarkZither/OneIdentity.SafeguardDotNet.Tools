...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicTaggingRuleTestResult : IEquatable<DynamicTaggingRuleTestResult>
    { 
        /// <summary>
        ...
        [DataMember(Name="TaggingRuleAction")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DynamicTaggingRuleTestResult)obj);
        }

        /// <summary>
        /// Returns true if DynamicTaggingRuleTestResult instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicTaggingRuleTestResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicTaggingRuleTestResult other)
        {
            ...
            return 
                ...
                (
                    TaggingRuleAction == other.TaggingRuleAction ||
                    TaggingRuleAction != null &&
                    TaggingRuleAction.Equals(other.TaggingRuleAction)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TaggingRuleAction != null)
                    hashCode = hashCode * 59 + TaggingRuleAction.GetHashCode();
                    if (AssetId != null)
        ...
        public static bool operator ==(DynamicTaggingRuleTestResult left, DynamicTaggingRuleTestResult right)
        {
