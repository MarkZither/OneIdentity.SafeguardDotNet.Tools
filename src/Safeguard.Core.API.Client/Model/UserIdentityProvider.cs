...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Information about user identity provider
  /// </summary>
  [DataContract]
  public class UserIdentityProvider {
    /// <summary>
    /// The id of the user's identity provider.
    /// </summary>
    /// <value>The id of the user's identity provider.</value>
    [DataMember(Name="Id", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "Id")]
    public int? Id { get; set; }

    /// <summary>
    /// The name of the user's identity provider. (Read-only)
    /// </summary>
    /// <value>The name of the user's identity provider. (Read-only)</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UserIdentityProvider {\n");
