...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AssetPolicyMembership : IEquatable<AssetPolicyMembership>
    { 
        /// <summary>
        ...
        [DataMember(Name="PolicyMemberIsAssetGroup")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AssetPolicyMembership)obj);
        }

        /// <summary>
        /// Returns true if AssetPolicyMembership instances are equal
        /// </summary>
        /// <param name="other">Instance of AssetPolicyMembership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetPolicyMembership other)
        {
            ...
            return 
                ...
                (
                    PolicyMemberIsAssetGroup == other.PolicyMemberIsAssetGroup ||
                    PolicyMemberIsAssetGroup != null &&
                    PolicyMemberIsAssetGroup.Equals(other.PolicyMemberIsAssetGroup)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (PolicyMemberIsAssetGroup != null)
                    hashCode = hashCode * 59 + PolicyMemberIsAssetGroup.GetHashCode();
        ...
        public static bool operator ==(AssetPolicyMembership left, AssetPolicyMembership right)
        {
