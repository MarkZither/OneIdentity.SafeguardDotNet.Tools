...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Me : IEquatable<Me>
    { 
        /// <summary>
        ...
        [DataMember(Name="Fido2Authenticators")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Me)obj);
        }
        ...
        public bool Equals(Me other)
        {
            ...
            return 
                ...
                (
                    Fido2Authenticators == other.Fido2Authenticators ||
                    Fido2Authenticators != null &&
                    Fido2Authenticators.SequenceEqual(other.Fido2Authenticators)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Fido2Authenticators != null)
                    hashCode = hashCode * 59 + Fido2Authenticators.GetHashCode();
                    if (AdminRoles != null)
