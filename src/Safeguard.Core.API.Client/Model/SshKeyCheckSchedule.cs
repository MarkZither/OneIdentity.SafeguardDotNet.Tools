...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// Represents a schedule used by a partition profile to check passwords
  /// </summary>
  [DataContract]
  public class SshKeyCheckSchedule {
    /// <summary>
    ...
    /// <summary>
    /// Flag to reset SSH key if an SSH key mismatch is found. Doesn't apply to manually invoked tasks.
    /// </summary>
    /// <value>Flag to reset SSH key if an SSH key mismatch is found. Doesn't apply to manually invoked tasks.</value>
    [DataMember(Name="ResetSshKeyOnMismatch", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ResetSshKeyOnMismatch")]
    public bool? ResetSshKeyOnMismatch { get; set; }

    /// <summary>
    /// Flag allowing users to be notified when a mismatch is found. Doesn't apply to manually invoked tasks.
    /// </summary>
    /// <value>Flag allowing users to be notified when a mismatch is found. Doesn't apply to manually invoked tasks.</value>
    [DataMember(Name="NotifyOwnersOnMismatch", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "NotifyOwnersOnMismatch")]
    public bool? NotifyOwnersOnMismatch { get; set; }

    /// <summary>
    /// Database Identifier of the asset partition this check schedule is assigned to (Read-only)
    /// </summary>
    /// <value>Database Identifier of the asset partition this check schedule is assigned to (Read-only)</value>
    [DataMember(Name="AssetPartitionId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "AssetPartitionId")]
    public int? AssetPartitionId { get; set; }

    /// <summary>
    /// Name of the asset partition this check schedule is assigned to (Read-only)
    /// </summary>
    /// <value>Name of the asset partition this check schedule is assigned to (Read-only)</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class SshKeyCheckSchedule {\n");
      sb.Append("  Name: ").Append(Name).Append("\n");
      sb.Append("  ResetSshKeyOnMismatch: ").Append(ResetSshKeyOnMismatch).Append("\n");
      sb.Append("  NotifyOwnersOnMismatch: ").Append(NotifyOwnersOnMismatch).Append("\n");
