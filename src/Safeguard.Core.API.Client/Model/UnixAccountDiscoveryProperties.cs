...
namespace IO.Swagger.Model {
  ...
  public class UnixAccountDiscoveryProperties {
    ...
    public UnixPropertyConstraintProperties PropertyConstraintProperties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class UnixAccountDiscoveryProperties {\n");
