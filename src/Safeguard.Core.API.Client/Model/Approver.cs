...
namespace IO.Swagger.Model {
  ...
  /// <summary>
  /// A user that is assigned as an approver
  /// </summary>
  [DataContract]
  public class Approver {
    ...
    /// <summary>
    /// Domain name of the Identity if applicable (Read-only)
    /// </summary>
    /// <value>Domain name of the Identity if applicable (Read-only)</value>
