...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ArchivePlatformConnectionProperties : IEquatable<ArchivePlatformConnectionProperties>
    { 
        /// <summary>
        ...
        [DataMember(Name="ServiceAccountSshKeyId")]
        ...
        [DataMember(Name="ServiceAccountSshKeyFingerprint")]
        ...
        [DataMember(Name="ServiceAccountSshKeyComment")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ArchivePlatformConnectionProperties)obj);
        }

        /// <summary>
        /// Returns true if ArchivePlatformConnectionProperties instances are equal
        /// </summary>
        /// <param name="other">Instance of ArchivePlatformConnectionProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchivePlatformConnectionProperties other)
        {
            ...
            return 
                ...
                (
                    ServiceAccountSshKeyId == other.ServiceAccountSshKeyId ||
                    ServiceAccountSshKeyId != null &&
                    ServiceAccountSshKeyId.Equals(other.ServiceAccountSshKeyId)
                ) && 
                (
                    ServiceAccountSshKeyFingerprint == other.ServiceAccountSshKeyFingerprint ||
                    ServiceAccountSshKeyFingerprint != null &&
                    ServiceAccountSshKeyFingerprint.Equals(other.ServiceAccountSshKeyFingerprint)
                ) && 
                (
                    ServiceAccountSshKeyComment == other.ServiceAccountSshKeyComment ||
                    ServiceAccountSshKeyComment != null &&
                    ServiceAccountSshKeyComment.Equals(other.ServiceAccountSshKeyComment)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ServiceAccountSshKeyId != null)
                    hashCode = hashCode * 59 + ServiceAccountSshKeyId.GetHashCode();
                    if (ServiceAccountSshKeyFingerprint != null)
                    hashCode = hashCode * 59 + ServiceAccountSshKeyFingerprint.GetHashCode();
                    if (ServiceAccountSshKeyComment != null)
                    hashCode = hashCode * 59 + ServiceAccountSshKeyComment.GetHashCode();
        ...
        public static bool operator ==(ArchivePlatformConnectionProperties left, ArchivePlatformConnectionProperties right)
        {
