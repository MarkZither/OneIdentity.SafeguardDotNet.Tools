...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class SshKeySyncGroupAccount {
    /// <summary>
    ...
    [DataMember(Name="SyncPriority", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SyncPriority")]
    public int? SyncPriority { get; set; }

    /// <summary>
    /// Whether the SshKey for this account is currently in sync with the sync group
    /// </summary>
    /// <value>Whether the SshKey for this account is currently in sync with the sync group</value>
    ...
    public SshKeySyncAccountTaskProperties TaskProperties { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class SshKeySyncGroupAccount {\n");
