...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SshKeyCheckSchedule : IEquatable<SshKeyCheckSchedule>
    { 
        /// <summary>
        ...
        [DataMember(Name="ResetSshKeyOnMismatch")]
        ...
        [DataMember(Name="NotifyOwnersOnMismatch")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SshKeyCheckSchedule)obj);
        }

        /// <summary>
        /// Returns true if SshKeyCheckSchedule instances are equal
        /// </summary>
        /// <param name="other">Instance of SshKeyCheckSchedule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshKeyCheckSchedule other)
        {
            ...
            return 
                ...
                (
                    ResetSshKeyOnMismatch == other.ResetSshKeyOnMismatch ||
                    ResetSshKeyOnMismatch != null &&
                    ResetSshKeyOnMismatch.Equals(other.ResetSshKeyOnMismatch)
                ) && 
                (
                    NotifyOwnersOnMismatch == other.NotifyOwnersOnMismatch ||
                    NotifyOwnersOnMismatch != null &&
                    NotifyOwnersOnMismatch.Equals(other.NotifyOwnersOnMismatch)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ResetSshKeyOnMismatch != null)
                    hashCode = hashCode * 59 + ResetSshKeyOnMismatch.GetHashCode();
                    if (NotifyOwnersOnMismatch != null)
                    hashCode = hashCode * 59 + NotifyOwnersOnMismatch.GetHashCode();
        ...
        public static bool operator ==(SshKeyCheckSchedule left, SshKeyCheckSchedule right)
        {
