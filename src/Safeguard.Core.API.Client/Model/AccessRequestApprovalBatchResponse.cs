...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class AccessRequestApprovalBatchResponse {
    /// <summary>
    /// Gets or Sets Response
    /// </summary>
    [DataMember(Name="Response", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "Response")]
    public AccessRequest Response { get; set; }
    ...
    public ApproveRequest Request { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AccessRequestApprovalBatchResponse {\n");
