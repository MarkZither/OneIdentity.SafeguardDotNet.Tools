...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ArchiveServerConnectionProperties {
    /// <summary>
    /// Gets or Sets TransferProtocolType
    /// </summary>
    [DataMember(Name="TransferProtocolType", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "TransferProtocolType")]
