...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ManagedDiscoveredAssetAccountBatchResponse {
    /// <summary>
    /// Gets or Sets Response
    /// </summary>
    [DataMember(Name="Response", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "Response")]
    public AssetAccount Response { get; set; }
    ...
    public DiscoveredAssetAccount Request { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ManagedDiscoveredAssetAccountBatchResponse {\n");
