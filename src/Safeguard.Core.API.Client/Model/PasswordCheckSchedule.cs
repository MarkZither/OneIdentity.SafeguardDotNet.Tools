...
namespace IO.Swagger.Model {
  ...
  public class PasswordCheckSchedule {
    ...
    /// <summary>
    /// Flag to reset password if a password mismatch is found. Doesn't apply to manually invoked tasks.
    /// </summary>
    /// <value>Flag to reset password if a password mismatch is found. Doesn't apply to manually invoked tasks.</value>
    [DataMember(Name="ResetPasswordOnMismatch", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ResetPasswordOnMismatch")]
    public bool? ResetPasswordOnMismatch { get; set; }
    ...
    /// <summary>
    /// Database Identifier of this Check Schedule's associated Asset partition (Read-only)
    /// </summary>
    /// <value>Database Identifier of this Check Schedule's associated Asset partition (Read-only)</value>
    [DataMember(Name="AssetPartitionId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "AssetPartitionId")]
    public int? AssetPartitionId { get; set; }

    /// <summary>
    /// Name of this Check Schedule's associated Asset partition
    /// </summary>
    /// <value>Name of this Check Schedule's associated Asset partition</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class PasswordCheckSchedule {\n");
      sb.Append("  Name: ").Append(Name).Append("\n");
      sb.Append("  ResetPasswordOnMismatch: ").Append(ResetPasswordOnMismatch).Append("\n");
